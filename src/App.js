          ...
          <section className="w-full flex flex-col  md:flex-row-reverse gap-4 my-12">
            ...
            <div className="w-full h-420 flex flex-col items-center justify-center ">
              <p className="text-lg text-textBase text-center">
                Hey, I'm a CS student with keen interest in frontend
                ...
                skill set. Tech stacks & tools i work upon - Html5 , CSS3,
                JavaScript,Typescript , Bootstrap, React Js ,React Native
              </p>
